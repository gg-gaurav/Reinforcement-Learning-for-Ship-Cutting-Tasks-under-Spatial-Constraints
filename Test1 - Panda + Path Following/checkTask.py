...
simulator.physics_client.resetDebugVisualizerCamera(cameraDistance= 1.0,            # Distance to the target position
                                              cameraYaw= -180,                      # adjust viewing angle
                                              cameraPitch= -40,                     # adjust tilt
                                              cameraTargetPosition=[0, 0, 0.1])     # Focus point
