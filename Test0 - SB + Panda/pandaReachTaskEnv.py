...
class pandaReachTaskEnv(RobotTaskEnv):
    ...
    def __init__(
        ...
        render_target_position: np.ndarray = [0, 0, 0.5],
        ...
        task = pandaReachTask(sim, get_ee_position=robot.get_ee_position, get_ee_velocity=robot.get_ee_velocity,
