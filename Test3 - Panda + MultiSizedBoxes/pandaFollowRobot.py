...
class pandaFollowRobot(PyBulletRobot):
    ...
    def EEControl_To_JointAngles(self, ee_disp: np.ndarray) -> np.ndarray:
        ...
        # Having orientation = None helps the EE to take whichever pose it wants to. Replacing it with the above orientation ensures
        # EE is always pointing downwards
