...
from pandaMultiSizedBoxesTask import pandaMultiSizedBoxesTask
...
class pandaMultiSizedBoxesTaskEnv(RobotTaskEnv):
    ...
    def __init__(
        ...
        robot = pandaFollowRobot(sim)
        task = pandaMultiSizedBoxesTask(sim, get_ee_position=robot.get_ee_position, get_ee_velocity=robot.get_ee_velocity,
                              distanceThreshold= robot.distanceThreshold)
        super().__init__(
            robot,
            task,
