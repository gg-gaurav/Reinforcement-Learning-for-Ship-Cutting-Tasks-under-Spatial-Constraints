...
class pandaOrientTaskEnv(RobotTaskEnv):
    ...
    def __init__(
        ...
        robot = pandaOrientRobot(sim)
        task = pandaOrientTask(sim, get_ee_position=robot.get_ee_position, get_ee_velocity=robot.get_ee_velocity,
