...
from pandaLTask import pandaLTask
from pandaLRobot import pandaLRobot

import numpy as np



class pandaLTaskEnv(RobotTaskEnv):
    ...
    def __init__(
        ...
        robot = pandaLRobot(sim)
        task = pandaLTask(sim, get_ee_position=robot.get_ee_position, get_ee_velocity=robot.get_ee_velocity)
        super().__init__(
            robot,
            task,
